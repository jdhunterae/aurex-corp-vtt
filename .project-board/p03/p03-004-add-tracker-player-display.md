...
Historical context: before this ticket, the Phase 2 player template rendered scene content only and visible trackers created by the GM did not appear on the player view.
