...
- Display modes that use mapped labels should include at least one nonblank named value.
- Tracker labels must not be blank.
- Tracker IDs are generated by the backend.
